"""
Django settings for tfms_core project.
...
WSGI_APPLICATION = 'tfms_core.wsgi.application'
...
# Email Backend (Local Development)
# This prints emails to the Terminal window instead of sending them.
